...
class ProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program" do
    assert_difference("Program.count") do
      post programs_url, params: { program: { faculty_id: @program.faculty_id, name: @program.name } }
    end
  ...
  test "should update program" do
    patch program_url(@program), params: { program: { faculty_id: @program.faculty_id, name: @program.name } }
